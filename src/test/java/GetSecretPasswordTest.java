...
public class GetSecretPasswordTest {
    List<String> wikiCommonPasswords = Stream.of(
    ...
    List<String> commonPasswords = wikiCommonPasswords.stream().distinct().collect(Collectors.toList());
...
//            System.out.println(body);
            ...
            Response responseCheckAuthCookie = RestAssured
                    ...
                    .andReturn();
//            responseCheckAuthCookie.prettyPrint();
